# fast_model_building.py - Lightweight and fast LSTM model
...
print("Building FAST lightweight model...")
...
model.save("fast_lstm_model.h5")
print("Fast model architecture saved as fast_lstm_model.h5") 